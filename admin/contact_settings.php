...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-2" style="max-height: 100px; overflow-y: auto;">
        <div class="mb-1"><h2 class="text-sm font-bold text-gray-900">Contact Details - Set contact information displayed for admin queries.</h2></div>
        <?php if ($success): ?><div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-3" role="alert"><span class="block sm:inline"><?php echo $success; ?></span></div><?php endif; ?>
        <?php if ($error): ?><div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-3" role="alert"><span class="block sm:inline"><?php echo $error; ?></span></div><?php endif; ?>
