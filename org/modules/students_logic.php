    ...
    if (!$conflict_student) {
        if ($student_id) {
            ...
            if ($photo_path) {
                ...
                $stmt->bind_param("ssssssssssssssssssssssssiddsdsisii", $name, $class, $stream, $batch, $roll_number, $address, $phone, $email, $photo_path, $sex, $sex_other, $date_of_birth, $place_of_birth, $nationality, $mother_tongue, $religion, $religion_other, $community, $community_other, $native_district, $pin_code, $parent_guardian_name, $parent_contact, $exam_name, $exam_total_marks, $exam_marks_obtained, $exam_percentage, $exam_grade, $admission_amount, $fees_json, $is_active, $remark, $student_id, $org_id);
            } else {
